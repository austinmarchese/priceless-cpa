...
const TRAPS: Trap[] = [
  {
    ...
    body: 'Your accountant shows up once a year with a number. A tax strategist shows up quarterly with a plan. This is the trap that makes every other trap on this page possible. If your CPA only talks to you in February and March, they are not your strategist. They are your filer.',
    example: 'A quarterly plan typically finds $30K to $80K in legitimate savings that an annual filing never touches.',
  },
  {
    number: '02',
    title: 'Running the wrong entity structure for your income.',
    body: 'If you are running $500K+ of profit through a sole prop or a default LLC, every dollar is getting hit with self-employment tax. At the right income level, electing S-Corp status flips a significant slice of that income from self-employment tax to distributions. Most accountants never run this math with you.',
    example: 'A clean S-Corp election on $500K of profit commonly saves $15K to $40K per year, every year going forward.',
  },
  {
    number: '03',
    title: 'Missing the reasonable compensation band inside your S-Corp.',
    body: 'Once you do have an S-Corp, most owners either pay themselves too much (giving back the savings) or too little (creating audit risk and blowing basis). There is a specific compensation band that captures the tax savings while staying defensible. Most accountants pick a number that feels safe for them, not optimal for you.',
    example: 'Moving an S-Corp owner from a $180K salary to a defensible $110K salary can free up $11K in payroll tax annually.',
  },
  {
    number: '04',
    title: 'Ignoring real estate as a tool against your business income.',
    body: 'Cost segregation, the short-term rental strategy, and Real Estate Professional Status can turn paper losses from real estate into active offsets against your operating business income. Most CPAs skip it because they do not understand it. Your real estate portfolio should be doing double duty: building wealth and shielding your operating income.',
    example: 'A $1.2M short-term rental with cost seg can generate $300K+ in first-year paper losses that offset business income directly.',
  },
  {
    number: '05',
    title: 'Running without a multi-year tax plan.',
    body: 'Roth conversions belong in low-income years. Retirement plan stacking (Solo 401k plus Defined Benefit) can shelter $200K+ per year when structured right. Exit planning should start 3 to 5 years before the sale, not 3 months before. None of this shows up inside a single-year filing mindset.',
    example: 'A founder selling a $10M business can save $500K+ in taxes with a 3-year runway that a single-year plan cannot see.',
  },
]
