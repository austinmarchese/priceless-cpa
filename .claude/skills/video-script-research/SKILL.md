...
1. If a slug was provided, read `projects/videos/[slug]/idea.md`
2. If no slug, list all project folders and ask which one to research
3. Read the persona: `wiki/audience/serial-entrepreneur/profile.md`
4. Scan `wiki/lived-experiences/` for relevant learnings on this topic
...
Save to `projects/videos/{slug}/outline.md`
...
Update `projects/videos/{slug}/outline.md` with the final enriched outline.

Update `projects/videos/{slug}/research.md` with:
