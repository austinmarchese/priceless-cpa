...
| YouTube skills | `.claude/skills/youtube-*/**` | Core content production workflows |
...
| Consultant agents | `.claude/agents/*-consultant*` | Changes expert feedback loops |
| Shared settings | `.claude/settings.json` | Affects all teammates' Claude Code behavior |
...
SAFE (N files)
  - .claude/skills/new-thing/SKILL.md -- new skill
...
RISKY (N files)
  ...
  - .claude/skills/youtube-4-script-writer/SKILL.md -- changed script workflow
```
