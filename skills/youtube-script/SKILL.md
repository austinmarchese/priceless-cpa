...
1. **Outlier Research**: `content/youtube/outliers/README.md` (proven patterns and first principles)
2. **Outlier Titles**: `content/youtube/outliers/titles.md` (19 analyzed videos with adapted titles)
...
5. **Format Library**: `context/shorts/format-library.md` (for tone/voice reference)
6. **Example Scripts**: `context/shorts/example-scripts.md` (for Anthony's voice)
7. **Lived Experiences**: scan `context/lived-experiences/` for relevant learnings
8. **Best Work**: scan `context/best-work/` for voice/style reference
...
Save to: `content/youtube/projects/[slug]/script.md`
...
From `content/youtube/outliers/titles.md`:
