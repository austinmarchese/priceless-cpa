...
```
Read: content/youtube/outliers/README.md (patterns + first principles)
Read: content/youtube/outliers/titles.md (19 analyzed videos with adapted titles)
Read: context/audience/serial-entrepreneur/profile.md
Read: context/audience/serial-entrepreneur/content-strategy.md
Read: context/shorts/format-library.md (for hook patterns)
Scan: content/youtube/projects/ (existing video ideas to avoid duplicates)
...
Read from `content/youtube/outliers/titles.md` for the 19 analyzed outliers and 5 adapted titles.
...
If locking one in:
1. Create project folder at `content/youtube/projects/[slug]/`
