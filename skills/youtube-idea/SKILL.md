...
1. **Outlier Research**: `content/youtube/outliers/README.md` (patterns + first principles)
2. **Outlier Titles**: `content/youtube/outliers/titles.md` (what's already been analyzed)
...
5. **Existing Projects**: scan `content/youtube/projects/` to avoid duplicating topics
6. **Lived Experiences**: scan `context/lived-experiences/` for topic inspiration
...
Save each idea to its own project folder: `content/youtube/projects/[slug]/idea.md`
