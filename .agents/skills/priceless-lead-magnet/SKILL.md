...
Codex: Let's build a new lead magnet. Who is this for, and what specific problem does it solve?

User: Real estate investors who aren't sure if they're getting the right deductions

Codex: Good audience. A few format options:
...
Codex: What headline? I'd suggest something like:
