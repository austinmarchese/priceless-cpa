# AGENTS.md - Priceless CPA Operating System
...
Skills are in `.Codex/skills/[name]/SKILL.md`. When the user runs `/[skill-name]`, read the SKILL.md and follow the process.
...
- **Agents**: `.Codex/agents/` contains agents organized by department
- **Templates**: `.Codex/templates/` contains reusable templates
